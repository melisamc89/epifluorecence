...
def run_cropper(row, parameters):
    ...
    data_dir = '/home/melisamc/Documentos/epifluorecence/data/preprocessing/cropping/main/'  ### replace this in OS
...
def run_motion_correction(row,parameters,dview):
    ...
    ### create output data for data base
    data_dir = '/home/melisamc/Documentos/epifluorecence/data/preprocessing/motion_correction/'
...
def run_alignment(rows,parameters,dview):
    ...
    output_mmap_file_path = f'/home/melisamc/Documentos/epifluorecence/data/preprocessing/alignment/main/{file_name}.mmap'
    ...
    data_dir = f'/home/melisamc/Documentos/epifluorecence/data/preprocessing/alignment/main/'
    file_name = db.create_file_name(2, name)
    fname= m_concat.save(data_dir + file_name + '.mmap', order='C')
    data_dir = f'/home/melisamc/Documentos/epifluorecence/data/preprocessing/alignment/main/'
    #file_name = db.create_file_name(2, name)
    #fname= m_concat.save(data_dir + file_name + '.tif')
    ...
    meta_data_dir = f'/home/melisamc/Documentos/epifluorecence/data/preprocessing/alignment/meta/'
...
def run_source_extraction(row, parameters, states_db, dview, multiple_files = False):
    ...
    data_dir = f'/home/melisamc/Documentos/epifluorecence/data/preprocessing/source_extraction/'
...
def run_component_evaluation(row, parameters, states_db, multiple_files = False):
    ...
    data_dir = f'/home/melisamc/Documentos/epifluorecence/data/preprocessing/component_evaluation/'
    output_file_path = data_dir + f'main/{file_name}.hdf5'
